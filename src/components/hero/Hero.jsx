...
const Hero = () => {
  return (
    <div className='flex flex-col items-center gap-4'>
        ...
        <h1 className='w-3/4 text-center text-8xl font-semibold'><span className='bg-clip-text bg-secondary text-transparent bg-gradient-to-b from-white to-blue-700'>I&apos;m Laxman Singh Koranga,</span><br />A Software Developer.</h1>
