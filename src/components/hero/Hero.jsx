...
const Hero = () => {
	return (
		<div className="flex flex-col items-center gap-4 mb-12">
			<img
				className="w-[330px] sm:w-96 mt-[60px] sm:mt-10 rounded-full hover:border-2 hover:boder-solid hover:border-gray-600 hover:animate-bounce duration-300 ease-linear transition-all"
				src={profile_img}
				alt="profile-image"
			/>
			<h1 className="w-11/12 sm:w-3/4 mt-[24px] sm:mt-0 text-center text-[47px] sm:text-8xl font-semibold">
			...
			<p className="w-3/5 sm:w-1/2 text-center text-[19px] sm:text-2xl leading-[25px] sm:leading-10">
			...
			<div className="flex flex-col sm:flex-row items-center gap-9 sm:gap-24 text-lg font-medium mt-5 sm:mt-3 mb-4">
				...
				<div className="px-12 sm:px-9 py-2 rounded-full border-2 border-none bg-primary cursor-pointer transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-110 duration-300">
					My Resume
				</div>
			</div>
		</div>
