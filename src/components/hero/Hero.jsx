        ...
        <div className='flex items-center gap-28 text-lg font-medium mt-3 mb-20'>
            <div className='flex gap-4'>
              <a href="https://www.linkedin.com/in/laxmankoranga03/" target='_blank' rel="noopener noreferrer">
                <img className='w-9 h-8 cursor-pointer transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-150 duration-200' src={linkedIn_icon} alt="linkedIn-icon" />
              </a>
              <a href="https://github.com/lxmn-22" target='_blank' rel="noopener noreferrer">
                <img className='w-9 h-8 cursor-pointer transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-150 duration-200' src={github_icon} alt="github-icon" />
              </a>
              <a href="https://x.com/lxmn22nov" target='_blank' rel="noopener noreferrer">
                <img className='w-9 h-8 cursor-pointer transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-150 duration-200' src={x_icon} alt="x_icon" />
              </a>
            </div>
