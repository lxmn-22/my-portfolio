    ...
    <div id="contact" className='flex flex-col items-center justify-center gap-12 mx-20 my-36'>
        ...
        <div className='flex gap-40'>
            ...
            <form onSubmit={onSubmit} className='flex flex-col items-start gap-7'>
                ...
                <button className='border-none text-white rounded-3xl bg-primary text-md px-6 py-2 mb-12 cursor-pointer transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-110 duration-300' type='submit'>Submit</button>
            </form>
            {/* <span>{result}</span> */}
        </div>
    </div>
