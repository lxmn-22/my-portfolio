    ...
    <div className='flex flex-col items-center justify-center gap-12 mx-20 my-36'>
        ...
        <div className='grid grid-cols-3 gap-4 mb-20'>
            {Services_Data.map((service, index)=> {
                return <div className='flex flex-col justify-center gap-6 px-9 py-3 rounded-xl border-2 transition-0.4s cursor-pointer hover:border-2 hover:bg-gradient-to-r from-gray-800 hover:border-blue-400 transition-0.4s' key={index}>
